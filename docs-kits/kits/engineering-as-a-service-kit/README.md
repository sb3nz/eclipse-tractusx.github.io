...
- [x] Copy template directory to `/docs-kits/kits/your-kit-name-kit/`
...
- [x] Register KIT in `/data/kitsData.js`-> **logo pending!!**
- [x] Add sidebar configuration in `/sidebarsDocsKits.js`
