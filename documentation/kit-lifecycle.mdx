...
```mermaid
graph LR
    A["1. Sandbox (MVP)"] --> B[2. Incubating]
    B --> C[3. Graduated]
    
    style A fill:#f59e0b,stroke:#d97706,stroke-width:2px,color:#fff
    style B fill:#72bd00,stroke:#65a30d,stroke-width:2px,color:#fff
    style C fill:#8246e1,stroke:#6b21a8,stroke-width:2px,color:#fff
```
...
<details>
<summary><strong>View Detailed Process with Incubating Sub-States</strong></summary>

```mermaid
graph TD
    A[1. Sandbox] --> B[2. Incubating]
    B --> B1[2.1 Draft]
    B --> B2[2.2 In Progress] 
    B --> B3[2.3 In Review]
    B1 --> B2
    B2 --> B3
    B3 --> C[3. Graduated]
    ...
    style B3 fill:#8b5cf6,stroke:#7c3aed,stroke-width:2px,color:#fff
    style C fill:#8246e1,stroke:#6b21a8,stroke-width:2px,color:#fff
    style D fill:#ef4444,stroke:#dc2626,stroke-width:2px,color:#fff
```

The detailed view shows the three sub-states within the Incubating level: **Draft**, **In Progress**, and **In Review**. Each sub-state represents a distinct phase of development progress before graduation.

</details>

# Detailed Maturity Levels

For more information look at the [TRG 10.03 - KIT Lifecycle](https://eclipse-tractusx.github.io/docs/release/trg-10/trg-10-03) documentation.


<h2 id="sandbox-level">
  <LightbulbIcon sx={{ fontSize: 24, color: '#f59e0b', marginRight: '8px', verticalAlign: 'middle' }} />
  {' '}1. Sandbox Level (MVP KIT)
</h2>

**Purpose**: Initial exploration and community validation

Sandbox is the entry point for new KIT ideas (Minimal Viable Product). At this stage, the focus is on establishing a clear vision, mission, and business value proposition. This level serves as a preview of potential business innovation and allows for community feedback and validation.
...
- No standards are mandatory, just a clear business vision
- Technical implementation proposal can already be done

### Minimal KIT Requirements for Sandbox (MVP) Level
...
<h2 id="incubating-level">
  <AssignmentIcon sx={{ fontSize: 24, color: '#72bd00ff', marginRight: '8px', verticalAlign: 'middle' }} />
  {' '}2. Incubating Level
</h2>
...
<h3 id="draft-state">
  <EditIcon sx={{ fontSize: 20, color: '#f59e0b', marginRight: '6px', verticalAlign: 'middle' }} />
  {' '}2.1 Draft State
</h3>
...
<h3 id="in-progress-state">
  <DeveloperModeIcon sx={{ fontSize: 20, color: '#3b82f6', marginRight: '6px', verticalAlign: 'middle' }} />
  {' '}2.2 In Progress State
</h3>
...
<h3 id="in-review-state">
  <VisibilityIcon sx={{ fontSize: 20, color: '#8b5cf6', marginRight: '6px', verticalAlign: 'middle' }} />
  {' '}2.3 In Review State
</h3>
...
<h2 id="graduated-level">
  <SchoolIcon sx={{ fontSize: 24, color: '#8246e1ff', marginRight: '8px', verticalAlign: 'middle' }} />
  {' '}3. Graduated Level
</h2>
