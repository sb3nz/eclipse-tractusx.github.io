          ...
          'kits/business-partner-kit/adoption-view',
          {
            ...
            items: [
              'kits/business-partner-kit/software-development-view/specification',
              {
                type: 'link',
                label: 'Gate API',
                href: 'https://eclipse-tractusx.github.io/api-hub/bpdm/7.1.0/gate/swagger-ui/'
              },
              {
                type: 'link',
                label: 'Pool API',
                href: 'https://eclipse-tractusx.github.io/api-hub/bpdm/7.1.0/pool/swagger-ui/'
              },
              {
                type: 'link',
                label: 'Orchestrator API',
                href: 'https://eclipse-tractusx.github.io/api-hub/bpdm/7.1.0/orchestrator/swagger-ui/'
              },
            ...
            items: [
              'kits/demand-and-capacity-management-kit/architecture-view/dependencies',
              {
                ...
                items: [
                  {
                    type: 'autogenerated',
                    dirName: 'kits/demand-and-capacity-management-kit/architecture-view/functional-view'
                  }
                ]
              }
            ]
